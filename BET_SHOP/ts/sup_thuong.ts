...
const ITEMS_PER_ST = 8; // 4 items per row, 2 rows initially visible

let allProducts3: SUPTHUONG[] = [];
let currentPage3 = 1;
...
document.addEventListener("DOMContentLoaded", () => {
    fetchProducts3();
    const viewMoreButton = document.getElementById("view-more-button3") as HTMLButtonElement | null;
    if (viewMoreButton) {
